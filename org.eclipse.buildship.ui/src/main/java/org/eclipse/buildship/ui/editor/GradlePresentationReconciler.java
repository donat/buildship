...
public final class GradlePresentationReconciler extends PresentationReconciler {
    ...
    private static class KeywordRule extends WordRule {
        ...
        private static final List<String> KEYWORDS = ImmutableList
                .of("assert", "if", "else", "void", "null", "new", "return", "try", "catch", "def", "allprojects", "artifacts", "buildscript", "configurations", "dependencies", "repositories", "sourceSets", "subprojects", "publishing", "task", "apply", "sourceCompatibility", "targetCompatibility", "test", "project", "ext", "plugins", "jar", "shadowJar", "for", "while");
    ...
    private static class SimpleScanner extends BufferedRuleBasedScanner {
        // BufferedRuleBasedScanner defines protected constructor
    }
